    ...
    currentConfigs.value = {
      providers: {
        ...
        openid: {
          ...
          fields: {
            issuer_url:
              getFieldValue(InfraConfigEnum.OpenidIssuerUrl),
            issuer_name:
              getFieldValue(InfraConfigEnum.OpenidIssuerName),
            issuer_icon_url:
              getFieldValue(InfraConfigEnum.OpenidIssuerIconUrl),
            authorization_endpoint:
              getFieldValue(InfraConfigEnum.OpenidAuthorizationEndpoint),
            token_endpoint:
              getFieldValue(InfraConfigEnum.OpenidTokenEndpoint),
            userinfo_endpoint:
              getFieldValue(InfraConfigEnum.OpenidUserinfoEndpoint),
            jwks_uri:
              getFieldValue(InfraConfigEnum.OpenidJwksUri),
            scopes:
              getFieldValue(InfraConfigEnum.OpenidScopes),
            end_session_endpoint:
              getFieldValue(InfraConfigEnum.OpenidEndSessionEndpoint),
            callback_url:
              getFieldValue(InfraConfigEnum.OpenidCallbackUrl),
            client_id:
              getFieldValue(InfraConfigEnum.OpenidClientId),
            client_secret:
              getFieldValue(InfraConfigEnum.OpenidClientSecret),
          }
        }
      },
      mailConfigs: {
