  ...
  isServiceConfigured(
    ...
    switch (service) {
      ...
      case AuthProvider.OPENID:
        return (
          configMap.OPENID_CLIENT_ID &&
          configMap.OPENID_CLIENT_SECRET &&
          configMap.OPENID_ISSUER_URL &&
          configMap.OPENID_SCOPE &&
          configMap.OPENID_CALLBACK_URL &&
          configMap.OPENID_AUTHORIZATION_ENDPOINT &&
          configMap.OPENID_TOKEN_ENDPOINT &&
          configMap.OPENID_USERINFO_ENDPOINT &&
          configMap.OPENID_JWKS_URI
        );
      default:
        return false;
    }
